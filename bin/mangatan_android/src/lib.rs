...
fn android_main(app: AndroidApp) {
    ...
    if !config_path.exists() {
        ...
        // 1. Launch the setup screen
        launch_setup_activity(&app);

        // 2. BLOCK and WAIT until the user creates the file.
        // android_main runs on a background thread, so this loop 
        // will not freeze the SetupActivity UI.
        ...
        loop {
            ...
            // Sleep for 500ms to save CPU while waiting for the user
